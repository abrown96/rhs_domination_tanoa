...
switch (KP_liberation_preset_blufor) do {
    default  {[] call compileFinal preprocessFileLineNumbers "presets\blufor\rhs_usaf_wdl.sqf";};
};

switch (KP_liberation_preset_opfor) do {
    default  {[] call compileFinal preprocessFileLineNumbers "presets\opfor\rhs_afrf.sqf";};
};

switch (KP_liberation_preset_resistance) do {
    default  {[] call compileFinal preprocessFileLineNumbers "presets\resistance\rhs_gref.sqf";};
};

switch (KP_liberation_preset_civilians) do {
    default  {[] call compileFinal preprocessFileLineNumbers "presets\civilians\apex.sqf";};
};
