...
*/
infantry_units = [
    ["rhsusf_usmc_marpat_wd_rifleman_light",5,0,0],                     // Rifleman (Light)
    ...
    ["rhsusf_usmc_marpat_wd_javelin",30,10,0],                          // AT Specialist
    ["rhsusf_usmc_marpat_wd_stinger",30,10,0],                          // AA Specialist
    ["rhsusf_navy_marpat_wd_medic",20,0,0],                             // Combat Life Saver
    ["rhsusf_usmc_marpat_wd_engineer",20,0,0],                          // Engineer
    ["rhsusf_usmc_marpat_wd_explosives",30,0,0],                        // Explosives Specialist
    ["rhsusf_usmc_recon_marpat_wd_rifleman_fast",20,0,0],               // Recon Scout
    ["rhsusf_usmc_recon_marpat_wd_rifleman_at",30,0,0],                 // Recon Scout (AT)
    ["rhsusf_usmc_recon_marpat_wd_marksman",30,0,0],                    // Recon Marksman
    ["rhsusf_usmc_recon_marpat_wd_sniper_M107",40,0,0],                 // Recon Sharpshooter
    ["rhsusf_navy_sarc_w_fast",30,0,0],                                 // Recon Paramedic
    ["rhsusf_usmc_recon_marpat_wd_grenadier_m32",30,0,0],               // Recon Demolition Expert
    ...
    ["B_Fighter_Pilot_F",10,0,0]                                        // Pilot
];
